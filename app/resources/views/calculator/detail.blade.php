                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a data-bs-toggle="tab" href="#result"
                                    @if ($page_tab == 'result') class="nav-link active" @else class="nav-link" @endif>切断指示</a>
                            </li>
                            <li class="nav-item">
                                <a data-bs-toggle="tab" href="#request"
                                    @if ($page_tab == 'request') class="nav-link active" @else class="nav-link" @endif>計算依頼内容</a>
                            </li>
                            <li class="nav-item">
                                <a data-bs-toggle="tab" href="#exception"
                                    @if ($page_tab == 'exception') class="nav-link active" @else class="nav-link" @endif>例外処理内容</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            {{-- 切断指示　Start --}}
                            <div id="result"
                                @if ($page_tab == 'result') class="tab-pane active" @else class="tab-pane" @endif>
                            ...
                            {{-- 例外処理内容　Start --}}
                            <div id="exception"
                                @if ($page_tab == 'exception') class="tab-pane active" @else class="tab-pane" @endif>
                                @foreach ($diameterDisplayList as $diameter => $id)
                                    <a @if ($id == $diameter_id) class="active_diameter" @endif
